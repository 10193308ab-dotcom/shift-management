...
export default function TodoPage() {
  ...
  return (
    <div style={{ padding: '1.5rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleAddTodo} className="card" style={{ display: 'flex', gap: '0.5rem', marginBottom: '2rem', padding: '1rem' }}>
        <input
          type="text"
        ...
        <input
          ...
          style={{ padding: '0.8rem', borderRadius: '8px', border: '1px solid var(--border-color)', fontSize: '0.9rem', color: 'var(--text-main)', width: '140px' }}
        />
        <button 
          type="submit" 
